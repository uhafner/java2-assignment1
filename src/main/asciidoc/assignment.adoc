= Übungsblatt 1 - Softwareentwicklung II
:icons: font
...
Die Abgabe dieses Übungsblattes ist möglich bis zum 1.4. 18:00. Laden Sie Ihre Lösung im GitHub Classroom https://classroom.github.com/a/OAFPfB1v[Assignment 1] auf den eigenen `main` Branch hoch.
